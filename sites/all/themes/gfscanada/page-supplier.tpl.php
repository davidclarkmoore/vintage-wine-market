    ...
    <div id="site-header" class="clear-block">
      <div id="top-part-of-header" class="grid-16 clear-block">
        <div id="branding" class="">
          <a href="/supplier" title="<?php t("Go to Supplier Homepage") ?>"><span></span><abbr title="Gordon Food Service">GFS</abbr>&mdash;Gordon Food Service</a>
        </div>
        ...
        <div id="site-menu" class="">
          <?php $nice_supplier_main_menu = theme('nice_menus', 0, 'menu-supplier-main-menu-links', 0, 'down', 1); ?>
          <?php print $nice_supplier_main_menu['content']; ?>              
          <a id="site_menu_homepage_link" class="iefix" href="/supplier" title="<?php t("Go to Supplier Homepage") ?>">GFS <?php print locale("Canada") ?></a>
        </div>
      </div>
    ...
    <?php endif; ?>
     ...
     <div id="footer">
        <div id="footer-top-region" class="region grid-16 clear-block">
          <div class="standard-cross-sells-wrap-outer">
            <div class="standard-cross-sells-wrap-inner">
              <div class="standard-cross-sells callout">
        ...
        <div id="footer-region" class="region grid-16 clear-block">
          <?php print $footer; ?>
          <a id="footer_us_homepage_link" href="http://www.gfs.com/" title="Go to GFS US"><img alt="Go to Gordon Food Service (US)." src="/sites/all/themes/gfscanada/images/GFSUSLogoImageChangeAsset.png"></img></a>
          <div class="copyright">&#169; <?php echo date('Y'); ?>  GFS Canada Company, Inc. All Rights Reserved.</div>
